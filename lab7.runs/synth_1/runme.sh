...
HD_PWD='C:/Users/ariky/Documents/CMPE100/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAcontrol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGAcontrol.tcl

...
HD_PWD='C:/Users/ariky/Documents/CMPE100/lab7/lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAcontrol.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGAcontrol.tcl -notrace
